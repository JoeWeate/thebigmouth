...
const EpisodeCardMediaPlayBtn = ({sx}) => {
    ...
    return (
        <SvgIcon
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" >
                ...
                <path className="pinkTriangle" d="M57.344,81.218V44.6L90.3,63.444Z" transform="translate(-22.286 -18.345)" fill="none" stroke="#e6007e" strokeWidth="2"/>
